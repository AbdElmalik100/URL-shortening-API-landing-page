<template>
    <footer class="py-5">
        <div class="container d-flex align-items-start justify-content-between">
            ...
            <div class="all-links d-flex align-items-start">
                <div class="features-links d-flex flex-column gap-4">
                    <span class="fw-bold text-light">Features</span>
                    <ul>
                        <li>Link Shotening</li>
                        <li>Brand Links</li>
                        <li>Analytics</li>
                    </ul>
                </div>
                <div class="resources-links d-flex flex-column gap-4">
                    <span class="fw-bold text-light">Resources</span>
                    <ul>
                        <li>Blog</li>
                        <li>Developers</li>
                        <li>Support</li>
                ...
                <div class="company-links d-flex flex-column gap-4">
                    <span class="fw-bold text-light">Company</span>
                    <ul>
                        <li>About</li>
                        <li>Our Team</li>
                        <li>Careers</li>
                ...
                <div class="socials-links d-flex align-items-start gap-4">
